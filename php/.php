...
$reponse = $bdd->query("SELECT email FROM member WHERE name='{$_SESSION['pseudo']}'");
$mail = $reponse['email'];
/* ADRESSE E-MAIL DU VENDEUR */
$emailto = "mypenpal.paypal@gmail.com";
...
if (strcmp ($res, "VERIFIED") == 0) {
	...
	$premium = '1';
	$req = $bdd->prepare("UPDATE member SET premium= ? WHERE name='{$_SESSION['pseudo']}' ");
	$req ->execute(array($premium));
